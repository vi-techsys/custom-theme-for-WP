					...
					<div class="op-mobile-menu col-lg-10 p-0 d-lg-flex align-items-center justify-content-end">
						...
						<ul id="menu-main-menu" class="nav-menu d-lg-flex flex-wrap list-unstyled justify-content-center ">
							<?php if ($_SESSION['logged_in'] == 'true') { ?>
								<li id="menu-item-67" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-61 current_page_item menu-item-67 nav-item"><a href="https://mobisilk.com/dashboard/" aria-current="page" class="nav-link js-scroll-trigger"><span>Home</span></a></li>
								<li id="menu-item-180" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-180 nav-item"><a href="https://about.php" class="nav-link js-scroll-trigger"><span>Sales Report</span></a></li>
								<li id="menu-item-180" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-180 nav-item"><a href="https://about.php" class="nav-link js-scroll-trigger"><span>Safe Report</span></a></li>
							...
							<?php } else { ?>
								<li id="menu-item-178" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-178 nav-item"><a href="https://mobisilk.com/user-login/" class="nav-link js-scroll-trigger"><span>Login</span></a></li>
								<li id="menu-item-179" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-179 nav-item"><a href="https://mobisilk.com/user-registration/" class="nav-link js-scroll-trigger"><span>Sign Up</span></a></li>
							<?php } ?>
						</ul>
					</div>
