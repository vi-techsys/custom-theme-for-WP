            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    ...
                    <form class=" form-horizontal" action="" method="POST">
                        <div style="color:white;"><input type="datetime-local" value="<?php echo isset($_POST['to']) ? $_POST['to'] : '' ?>" name="to" required /> :To &nbsp;&nbsp; <input type="datetime-local" value="<?php echo isset($_POST['from']) ? $_POST['from'] : '' ?>" name="from" required /> :From</div><br>
